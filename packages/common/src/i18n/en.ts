...
export default {
  ...
  reportIssue: {
    ...
    address: "The address is wrong",
    phone: "The phone number is wrong",
    website: "The website link is wrong",
    schedule: "The schedule is wrong",
    directions: "The directions are wrong",
    noFeedbackSubmitted:
    ...
    submissionSuccess:
      "The problem has been submitted and will be reviewed. Thank you for your feedback!",
  },
  resource: {
    address: "Address",
  ...
  subcategories: {
    ...
    feminineProducts: "Feminine Products",
